function [assignedAirCPlist] = AirWayPointDistributionOpt(numOfAirObservPoints, ObsPointlist, AirDroneStartpoint,numOfAirDrones, AirDroneLocInMeters)
...
%         assignedAirCPlist(listnum,3) = airCPassign(listnum,3);
%         assignedAirCPlist(listnum,4) = airCPassign(listnum,4);
        assignedAirCPlist(listnum,8) = droneID(1,droneIDlistPos);
...
%     end
    ...
    if foundit > 0
        temp3 = [ temp2(foundit:length(temp2),:);
                  temp2(1:foundit-1,:)];                 
    end
